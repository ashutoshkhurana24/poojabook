...
async function main() {
  ...
  const categoryImages: Record<string, string> = {
    ...
    'hanuman': 'https://i0.wp.com/yourspositively.com/wp-content/uploads/2020/07/Use-this-featured-Hanuman-1.jpg?fit=640%2C426&ssl=1',
  ...
  for (const poojaData of poojas) {
    ...
    // Create slots for next 60 days - all available
    ...
    for (let i = 1; i <= 60; i++) {
      ...
      const times = ['07:00', '08:00', '09:00', '10:00', '11:00', '16:00', '17:00', '18:00']
