...
export const POOJA_GUIDES: PoojaGuide[] = [
  ...
  // ─── Ayudha Puja ──────────────────────────────────────────────────────────
  {
    ...
    icon: '⚔️',
    category: 'Festivals & Navratri',
    deity: 'Goddess Saraswati & Goddess Durga',
    slug: 'ayudha-puja',
    shortDesc: 'Sacred worship of tools, weapons, and instruments on the ninth day of Navratri.',
    duration: '1–2 hours',
    difficulty: 'Easy',
    region: 'Pan-India (especially South India, Karnataka, Tamil Nadu)',
    whatIsThis: {
      summary: 'Ayudha Puja is the worship of tools, weapons, vehicles, and instruments.',
      details: 'Celebrated on Mahanavami (ninth day of Navratri), Ayudha Puja involves cleaning and decorating all tools, vehicles, machines, and instruments — from ploughs and hammers to laptops and cars — and offering them to the divine. It is believed that the divine energy (shakti) resides in all instruments that help us work and earn a livelihood.',
      significance: 'Ayudha Puja honors the instruments of our livelihood, acknowledging that they are extensions of the divine. By worshipping them, we express gratitude for the means of our sustenance and invite continued divine blessings into our work.',
    },
    bestTime: {
      time: 'Mahanavami (9th day of Navratri)',
      days: ['Navami'],
      tithis: ['Mahanavami'],
      occasions: ['Navratri', 'Vijayadashami eve'],
    },
    process: [
      { step: 1, title: 'Clean All Instruments', duration: '30 min', desc: 'Thoroughly clean and polish all tools, vehicles, machines, and instruments to be worshipped.' },
      { step: 2, title: 'Decorate with Flowers', duration: '15 min', desc: 'Adorn the items with garlands of marigold and mango leaves. Apply kumkum and turmeric.' },
      { step: 3, title: 'Set Up the Puja Space', duration: '10 min', desc: 'Place a clean cloth or banana leaf. Arrange all items neatly. Place a lamp and incense.' },
      { step: 4, title: 'Invoke the Goddess', duration: '10 min', desc: 'Light the lamp, offer flowers and incense to Goddess Saraswati and Goddess Durga, and chant invocation mantras.' },
      { step: 5, title: 'Offer Prasad', duration: '10 min', desc: 'Offer fruits, coconut, sweets, and betel leaves to the deity and the worshipped instruments.' },
      { step: 6, title: 'Aarti and Prayers', duration: '10 min', desc: 'Perform aarti with camphor and offer prayers for skill, safety, and success in your work.' },
    ],
    samagri: [
      { item: 'Marigold garlands', quantity: '5–6', essential: true },
      { item: 'Kumkum (red powder)', quantity: '1 pack', essential: true },
      { item: 'Turmeric powder', quantity: '50 g', essential: true },
      { item: 'Coconut', quantity: '1', essential: true },
      { item: 'Camphor (kapoor)', quantity: '10 g', essential: true },
      { item: 'Incense sticks (agarbatti)', quantity: '1 pack', essential: true },
      { item: 'Oil lamp (diya)', quantity: '1', essential: true },
      { item: 'Fruits (bananas, apples)', quantity: 'assorted', essential: false },
      { item: 'Betel leaves (paan)', quantity: '5', essential: false },
      { item: 'Mango leaves (toran)', quantity: '1 bunch', essential: false },
    ],
    benefits: [
      { benefit: 'Blessings on Work',       icon: '🔧', desc: 'Ensures smooth and safe operation of all instruments and vehicles throughout the year.' },
      { benefit: 'Protection from Accidents', icon: '🛡️', desc: 'Invokes divine protection over machinery and tools to prevent mishaps.' },
      { benefit: 'Skill Enhancement',       icon: '🎯', desc: 'Goddess Saraswati blesses practitioners with enhanced skill and precision.' },
      { benefit: 'Gratitude and Prosperity',icon: '🌟', desc: 'Cultivates an attitude of gratitude for the means of livelihood, inviting greater abundance.' },
      { benefit: 'Spiritual Merit',         icon: '🕉️', desc: 'Observing Ayudha Puja on Navami earns punya (merit) and Goddess Durga\'s blessings.' },
    ],
    mantras: [
      { name: 'Saraswati Vandana', text: 'Ya Kundendu Tusharahara Dhavala\nYa Shubhravasthravrita\nYa Veena Varadanda Manditakara\nYa Shveta Padmasana', repetitions: 3 },
      { name: 'Durga Saptashati Mantra', text: 'Sarva Mangala Mangalye\nShive Sarvartha Sadhike\nSharanye Tryambake Gauri\nNarayani Namostute', repetitions: 11 },
    ],
    relatedPoojas: ['ganesh-puja', 'navratri-puja', 'saraswati-puja'],
    bookingCTA: { text: 'Book Ayudha Puja with Expert Pandit', url: '/poojas/ayudha-puja' },
  },
  ...
  // ─── Mahalaxmi Vrat ───────────────────────────────────────────────────────
  {
    ...
    slug: 'mahalaxmi-vrat',
    shortDesc: 'A 16-day fasting vow observed for Goddess Mahalaxmi for wealth, prosperity, and family wellbeing.',
    duration: '16 days (puja each day ~1 hour)',
    difficulty: 'Medium',
    region: 'Maharashtra, Karnataka, Andhra Pradesh, Pan-India',
    whatIsThis: {
      summary: 'Mahalaxmi Vrat is a 16-day observance dedicated to Goddess Mahalaxmi, the deity of wealth and prosperity.',
      details: 'Observed in the month of Bhadrapada (August–September), Mahalaxmi Vrat begins on the eighth day (Ashtami) of Shukla Paksha. Devotees — primarily women — observe a fast for 16 days, performing daily puja to Goddess Mahalaxmi with lotus flowers, yellow items, and special offerings. On the 16th day, a grand puja is performed and the vrat is concluded by distributing prasad to 16 married women.',
      significance: 'This vrat is observed to please Goddess Mahalaxmi and invoke her blessings for wealth, health, happiness, and the wellbeing of the family. It is believed that observing this vrat with sincerity removes poverty, removes obstacles, and brings abundance into the household.',
    },
    bestTime: {
      time: 'Bhadrapada Shukla Ashtami (August–September)',
      days: ['Ashtami', 'Daily for 16 days'],
      tithis: ['Bhadrapada Shukla Ashtami'],
      occasions: ['Mahalaxmi Vrat', 'Bhadrapada month'],
    },
    process: [
      { step: 1, title: 'Sankalp (Vow Taking)', duration: '10 min', desc: 'On the first day (Ashtami), take a vow before Goddess Mahalaxmi to observe the 16-day fast with devotion.' },
      { step: 2, title: 'Daily Puja Setup', duration: '15 min', desc: 'Each day, clean the puja space, place a picture or idol of Goddess Mahalaxmi, and decorate with yellow flowers and lotus.' },
      { step: 3, title: 'Kalash Sthapana', duration: '10 min', desc: 'Place a copper or clay pot (kalash) filled with water, mango leaves, and a coconut as the symbol of the goddess.' },
      { step: 4, title: 'Daily Puja and Aarti', duration: '30 min', desc: 'Offer turmeric, kumkum, 16 flowers, 16 fruits, and 16 betel nuts to the goddess. Light incense and diya. Sing Mahalaxmi aarti.' },
      { step: 5, title: 'Mahalaxmi Vrat Katha', duration: '20 min', desc: 'Read or listen to the Mahalaxmi Vrat Katha (story) daily to understand the significance and deepen devotion.' },
      { step: 6, title: 'Samapti (Conclusion) on Day 16', duration: '60 min', desc: 'On the final day, perform a grand puja with 16 items. Invite 16 married women (sumangalis), worship their feet, and distribute prasad. Conclude the vrat with a feast.' },
    ],
    samagri: [
      { item: 'Mahalaxmi idol or picture', quantity: '1', essential: true },
      { item: 'Lotus or yellow flowers', quantity: '16 per day', essential: true },
      { item: 'Kumkum (red powder)', quantity: '1 pack', essential: true },
      { item: 'Turmeric powder', quantity: '100 g', essential: true },
      { item: 'Kalash (copper/clay pot)', quantity: '1', essential: true },
      { item: 'Coconut', quantity: '1', essential: true },
      { item: 'Mango leaves', quantity: '1 bunch', essential: true },
      { item: 'Oil lamp (diya)', quantity: '1', essential: true },
      { item: 'Incense sticks', quantity: '1 pack', essential: true },
      { item: 'Yellow fruits (bananas, mangoes)', quantity: '16 per day', essential: false },
      { item: 'Betel nuts (supari)', quantity: '16', essential: false },
      { item: 'Yellow cloth / silk', quantity: '1 piece', essential: false },
      { item: 'Camphor (kapoor)', quantity: '10 g', essential: true },
    ],
    benefits: [
      { benefit: 'Wealth & Abundance',      icon: '💰', desc: 'Invokes Goddess Mahalaxmi\'s direct blessings for financial prosperity and material abundance.' },
      { benefit: 'Family Wellbeing',        icon: '👨‍👩‍👧‍👦', desc: 'Protects the family from illness, misfortune, and negative energies.' },
      { benefit: 'Removal of Poverty',      icon: '🌟', desc: 'The vrat is believed to permanently remove poverty and financial obstacles from the household.' },
      { benefit: 'Marital Happiness',       icon: '💕', desc: 'Blesses married couples with harmony, love, and a long, happy life together.' },
      { benefit: 'Spiritual Merit',         icon: '🕉️', desc: 'Observing this vrat with full devotion earns immense punya and Goddess Lakshmi\'s eternal grace.' },
    ],
    mantras: [
      { name: 'Mahalaxmi Ashtakam', text: 'Namasthestu Mahamaye\nShripithe Surapujite\nShankha Chakra Gadadhare\nMahalakshmi Namostute', repetitions: 16 },
      { name: 'Lakshmi Beej Mantra', text: 'Om Shreem Hreem Shreem\nKamale Kamalalaye\nPrasida Prasida\nShreem Hreem Shreem Om Mahalakshmyai Namah', repetitions: 108 },
    ],
    relatedPoojas: ['lakshmi-puja', 'satyanarayan-puja', 'ganesh-puja'],
    bookingCTA: { text: 'Book Mahalaxmi Vrat Puja with Expert Pandit', url: '/poojas/mahalaxmi-vrat' },
  },
]
